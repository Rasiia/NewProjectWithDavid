   ...
   @Given("user navigates to the {string}")
    ...
    public void and_User_click_Sign_in_button() {
     nhsMainPage.successSignIn();
      ...
      public void user_click_the_add_patient_button_on_the_left_side_i_the_page() {
    ...
    public void user_provides_the_information_First_Name_Last_Name_Hospital_no_Date_of_birth_Sex_Male_Female() throws InterruptedException {
        addpatientPage.provideInformation("Rasiia", "Daniiarova", "55", "23.02.2023", "Female");
    }
    ...
    public void user_should_be_able_to_see_patient_is_added_to_the_main_page_under_Patients_waiting(io.cucumber.datatable.DataTable dataTable) {
